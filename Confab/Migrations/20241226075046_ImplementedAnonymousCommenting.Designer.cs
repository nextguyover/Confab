...
namespace Confab.Migrations
{
    ...
    [Migration("20241226075046_ImplementedAnonymousCommenting")]
    partial class ImplementedAnonymousCommenting
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Confab.Data.DatabaseModels.ClientIPSchema", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Confab.Data.DatabaseModels.UserSchema", b =>
                {
                    b.HasOne("Confab.Data.DatabaseModels.ClientIPSchema", "CreationIP")
                        .WithMany("CreatedAnonUsers")
                        .HasForeignKey("CreationIPId");

                    b.Navigation("CreationIP");
                });

            modelBuilder.Entity("Confab.Data.DatabaseModels.ClientIPSchema", b =>
                {
                    b.Navigation("CreatedAnonUsers");
                });
